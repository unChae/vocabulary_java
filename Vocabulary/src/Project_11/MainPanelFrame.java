...
public class MainPanelFrame implements ActionListener, MouseListener, KeyListener {
	...
	MainPanelFrame(DataClass data, MainFrame f, QuizClass quiz) {
		...
		f.pnlMenu.setBorder(new MatteBorder(3, 0, 1, 1, (Color) new Color(39, 39, 39)));
		...
		f.pnlMainCard.setBounds(286, 35, 605, 493);

		f.pnlMainCard.add(f.pnlVoca, "editor");

		f.pnlVoca.setLayout(null);
		f.pnlVoca.setBorder(new MatteBorder(0, 0, 3, 1, (Color) new Color(39, 39, 39)));
		...
		f.pnlTable.setBounds(0, 113, 604, 376);
		...
		f.pnlQuiz.setBorder(new MatteBorder(0, 0, 3, 1, (Color) new Color(39, 39, 39)));
