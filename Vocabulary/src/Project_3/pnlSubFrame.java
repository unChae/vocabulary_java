...
public class pnlSubFrame implements ActionListener {
	...
	pnlSubFrame(JPanel pnlBg, JMenu mnuSetup, JMenu mnuSwitch) {
		this.pnlBg = pnlBg;
		this.mnuSetup = mnuSetup;
		this.mnuSwitch = mnuSwitch;
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Login":
			...
			if(login.success == true) {
				mnuSetup.setEnabled(true);
				mnuSwitch.setEnabled(true);
				login.success = false;
			}
			break;
		case "NewAccount":
			...
			break;
		case "Create":
			login.createAccount(txtInfor[0].getText(),(String) cmdEmail.getSelectedItem(),txtInfor[1].getText(),txtInfor[2].getText(),txtInfor[3].getText());
			break;
		case "Back":
